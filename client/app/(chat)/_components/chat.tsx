...
import { Edit, Paperclip, Send, Smile } from "lucide-react";
    ...
    <div className="flex flex-col justify-end z-40 min-h-[92vh] sidebar-custom-scrollbar overflow-y-scroll">
      ...
      <Form {...messageForm}>
        <form
          ...
          className="w-full sm:w-[calc(100vw-340px)] p-4 fixed bottom-0 bg-background/50 backdrop-blur-sm border-t"
          ref={scrollRef}
        >
          {editedMessage && (
            <div className="flex gap-3 mb-5">
              <Edit />
              <div>{editedMessage.text}</div>
            </div>
          )}
          <div className="flex gap-5">
            ...
            <Button className="text-white p-2" type="submit" size={"icon"}>
              <Send />
            </Button>
          </div>
        </form>
